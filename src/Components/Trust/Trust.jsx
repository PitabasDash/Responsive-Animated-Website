    ...
    <section className='bg-brandWhite py-16 mt-20'>
      <div className='container'>
        <motion.h1
          ...
          initial="initial"
          whileInView="animate"h1   className="py-6 text-4xl font-bold text-darkBlue text-center"> Why you can trust this tools</motion.h1>
      <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
        <motion.div
            variants={SlideUp(0.4)}
            initial="initial"
            whileInView="animate" className='space-y-6 text-center md:text-left md:px-32'>
